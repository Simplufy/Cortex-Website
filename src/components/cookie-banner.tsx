...
export function CookieBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-3xl flex-col gap-3 rounded-2xl border border-fg/10 bg-elevated p-3 shadow-[0_16px_40px_-20px_rgba(22,18,16,0.25)] backdrop-blur-xl sm:flex-row sm:items-center sm:gap-4 sm:p-6">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            className="min-h-11 flex-1 rounded-full bg-gold px-4 py-2 text-xs font-semibold tracking-widest text-on-gold uppercase hover:bg-gold-light sm:flex-none"
          >
            Accept
          </button>
        </div>
