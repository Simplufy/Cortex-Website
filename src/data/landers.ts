...
function cover(slug: string) {
  return `/images/cortex/covers/${slug}.jpg?v=4`;
}

function keep(tools: string) {
  return `${tools} 30-minute walkthrough. No pack of agents. No obligation to build.`;
}
...
export const LANDERS: Lander[] = [
  {
    ...
    noun: "shop",
    headline: "Your shop is losing work Tekmetric already has.",
    headlineGold: "We’ll map estimates, missed calls, and the owner report.",
    seoTitle: "AI for Auto Repair Shops | Free AI Operations Audit",
    seoDescription:
      "Your shop is losing work Tekmetric already has. See what custom AI agents could actually do with aging ROs, declined work, and missed calls — without replacing Tekmetric, Shopmonkey, your CRM, or your books.",
    subcopy:
      "Auto repair, collision, detailing, glass, tires. Agents watch the leftover in the shop software you already run so follow-up isn’t whoever happens to be free.",
    ...
    layerBody:
      "We don’t replace your CRM, shop system, phone, ads, or accounting software. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    finalTitle: "Find out what AI could actually do inside your shop.",
  ...
  },
  {
    ...
    noun: "company",
    headline: "Unsold HVAC installs are sitting in ServiceTitan.",
    headlineGold: "We’ll map estimates, memberships, and callbacks.",
    seoTitle: "AI for HVAC Companies | Free AI Operations Audit",
    seoDescription:
      "Unsold HVAC installs are sitting in ServiceTitan. See what custom AI agents could actually do with aging quotes, lapsed memberships, and callbacks — without replacing ServiceTitan, Jobber, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace ServiceTitan, Jobber, your CRM, phone, ads, or accounting software. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
        title: "Estimate follow-up",
    ...
    finalTitle: "Find out what AI could actually do inside your HVAC company.",
    vslSrc: HOME_SRC,
  ...
  },
  {
    ...
    noun: "company",
    headline: "Missed plumbing calls are jobs down the street.",
    headlineGold: "We’ll map voicemail, bumps, and unbilled after-hours.",
    seoTitle: "AI for Plumbing Companies | Free AI Operations Audit",
    seoDescription:
      "Missed plumbing calls are jobs down the street. See what custom AI agents could actually do with voicemail, bumped booked work, and unbilled after-hours — without replacing ServiceTitan, Jobber, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace your field software, CRM, phone, ads, or books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        body: "That’s the point. Emergency work blows up the board. Agents watch the leftover — missed calls, bumped jobs, unbilled after-hours — so it doesn’t wait until Monday.",
      },
      {
        title: "Do you sell a pack of agents?",
        body: "No. We start with your company, your software, your bottlenecks. The audit is how we find the first path worth building.",
    ...
    finalTitle: "Find out what AI could actually do inside your plumbing company.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
  ...
  },
  {
    ...
    noun: "company",
    headline: "Electrical bids stall the minute the estimator is on a job.",
    headlineGold: "We’ll map permits, extras, and unbilled work.",
    seoTitle: "AI for Electrical Contractors | Free AI Operations Audit",
    seoDescription:
      "Electrical bids stall the minute the estimator is on a job. See what custom AI agents could actually do with aging estimates, permits, and verbal extras — without replacing ServiceTitan, Accubid, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace your field software, estimating tools, CRM, or books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    finalTitle: "Find out what AI could actually do inside your electrical company.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
  ...
  },
  {
    ...
    noun: "company",
    headline: "Storm leads go cold while the file sits in AccuLynx.",
    headlineGold: "We’ll map supplements, production, and collections.",
    seoTitle: "AI for Roofing Companies | Free AI Operations Audit",
    seoDescription:
      "Storm leads go cold while the file sits in AccuLynx. See what custom AI agents could actually do with aged leads, supplements, and uncollected roofs — without replacing AccuLynx, JobNimbus, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace AccuLynx, JobNimbus, Hover, your CRM, or your books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    finalTitle: "Find out what AI could actually do inside your roofing company.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
  ...
  },
  {
    ...
    noun: "company",
    headline: "Your home service company still runs on the owner’s phone.",
    headlineGold: "We’ll map inbox leads, dispatch, and unsent invoices.",
    seoTitle: "AI for Home Service Companies | Free AI Operations Audit",
    seoDescription:
      "Your home service company still runs on the owner’s phone. See what custom AI agents could actually do with inbox leads, dispatch by text, and unsent invoices — without replacing Jobber, Housecall Pro, your CRM, or your books.",
    subcopy:
      "Garage, lawn, restoration, multi-trade, cleaning. Agents watch the leftover between the schedule and the group chat so the owner isn’t the integration.",
    ...
    layerBody:
      "We don’t replace Jobber, Housecall Pro, your CRM, phone, or books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    finalTitle: "Find out what AI could actually do inside your company.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
  ...
  },
  {
    ...
    noun: "company",
    headline: "Skipped pest stops walk while the route looks full.",
    headlineGold: "We’ll map skips, cancellations, and lapsed renewals.",
    seoTitle: "AI for Pest Control Companies | Free AI Operations Audit",
    seoDescription:
      "Skipped pest stops walk while the route looks full. See what custom AI agents could actually do with skip-stops, cancelled accounts, and renewals — without replacing PestPac, FieldRoutes, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace PestPac, FieldRoutes, Jobber, your CRM, or your books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    finalTitle: "Find out what AI could actually do inside your pest company.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
  ...
  },
  {
    ...
    noun: "firm",
    headline: "Yes on site is still not a change order.",
    headlineGold: "We’ll map bids, extras, and closeout.",
    seoTitle: "AI for Contracting Firms | Free AI Operations Audit",
    seoDescription:
      "Yes on site is still not a change order. See what custom AI agents could actually do with aging bids, verbal extras, and unpaid closeout — without replacing Buildertrend, Procore, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace Buildertrend, Procore, JobNimbus, your CRM, or your books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
        title: "Bid follow-up",
    ...
    finalTitle: "Find out what AI could actually do inside your firm.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
  ...
  },
  {
    ...
    noun: "firm",
    headline: "The house looks finished. The file still thinks you’re waiting on a switch.",
    headlineGold: "We’ll map quotes, backorders, and programming.",
    seoTitle: "AI for Smart Home Integrators | Free AI Operations Audit",
    seoDescription:
      "The house looks finished. The file still thinks you’re waiting on a switch. See what custom AI agents could actually do with stalled quotes, backorders, and unbilled extras — without replacing D-Tools, Jetbuilt, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace D-Tools, Jetbuilt, ServiceTitan, Snap One, or your books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
  ...
  },
  {
    ...
    noun: "company",
    headline: "Install day is when you find out the order never went in.",
    headlineGold: "We’ll map factory dates, slips, and unsigned finals.",
    seoTitle: "AI for Window and Door Companies | Free AI Operations Audit",
    seoDescription:
      "Install day is when you find out the order never went in. See what custom AI agents could actually do with sold measures, factory slips, and unsigned finals — without replacing JobNimbus, Hover, your CRM, or your books.",
    subcopy:
    ...
    layerBody:
      "We don’t replace JobNimbus, Hover, Windowmaker, your CRM, or your books. We connect them through an AI layer, then build agents that actually do work across them.",
    agents: [
      {
    ...
    finalTitle: "Find out what AI could actually do inside your window company.",
    vslSrc: HOME_SRC,
    vslPoster: HOME_POSTER,
