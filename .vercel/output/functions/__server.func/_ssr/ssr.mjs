...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-mQO29PqS.mjs");
...
var manifest = {
	"13422380776f371a61a0e54cb4c18c2d6bafbfadf9debaffe84ee51cd6c9b752": {
		functionName: "submitAudit_createServerFn_handler",
		importer: () => import("./submit-audit-gGllhEUh.mjs")
	},
	"43ac094156d8d5b04d182baf24589862a219a9ca92accf85c6d75e51859b1f7b": {
		functionName: "qualifyAudit_createServerFn_handler",
		importer: () => import("./submit-audit-gGllhEUh.mjs")
	},
	"4c33c5be5d9ca3fc96550a0722a86a95aca5837abfcd14fca95206844db116fe": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DEkOF6vF.mjs").then((n) => n.t),
