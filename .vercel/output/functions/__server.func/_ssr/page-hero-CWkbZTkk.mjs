...
import { _ as GhostButton, a as ClutchBadge, g as BeamButton } from "./router-D5iiC1sJ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/page-hero-CWkbZTkk.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				clutch && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mb-8",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-8 max-w-2xl text-balance text-lg leading-relaxed font-light text-fg/60 md:text-xl",
					children: body
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-10 flex w-full flex-col items-center gap-6 sm:w-auto sm:flex-row",
